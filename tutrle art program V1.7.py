...
the dimensions of the box are 960 pixels by 792 pixels""")
...
Movement:
    f/forward, b/back, setpos/setposition/sp, p/pos/getpos/gp, h/home, speed/setspeed/ss
Angle:
...
Colour:
    ...
    endfill/efill/ef
Miscellaneous:
    clear/clearscreen, h/help, quit, hide, show, turtleshape/cursor/setcursor
...
format: arc *radius* *degrees*""")
                ...
                print("""The polygon command draws a regular polygon with the radius and num of sides provided, WARNING THE POLY COMMAND DRAWS THE SHAPE RORATED 45 DEGREES TO THE LEFT OF THE TURTLE
